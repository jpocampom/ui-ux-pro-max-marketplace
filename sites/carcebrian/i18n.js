...
window.I18N = {
  ...
  es: {
    ...
    pricing: {
      ...
      sub: "La primera sesión es gratuita. Si decides avanzar, el proyecto parte de 350 € y crece con el alcance. Y si eliges Reamueblar o Diseñar, la fase de Estilizar va incluida.",
      roomsLabel: "¿Cuántas estancias?",
      rooms: ["1–2 estancias", "3–5 estancias", "+5 estancias"],
      weeks: "semanas", popular: "El más elegido", custom: "Presupuesto a medida", customWeeks: "Plazo según proyecto",
      ...
      rule3: "Coste mínimo si decides avanzar: 350 €. Precios orientativos según alcance; IVA no incluido.",
      tableToggle: "Ver tabla completa de precios y plazos",
      tableScope: "Alcance",
      features: {
    ...
    quiz: {
      ...
      sub: "Responde a 5 preguntas y te digo qué servicio encaja, con precio y plazo orientativos. Después, reserva tu primera sesión gratis.",
      ...
      estimate: "Inversión orientativa", duration: "Plazo estimado", weeksShort: "sem.",
      customPrice: "A medida", customWeeks: "Según proyecto",
      inclNote: "Al ser un proyecto de {service}, la fase de Estilizar va incluida sin coste.",
      budgetNote: "Con tu presupuesto podemos empezar por una versión más acotada (menos estancias o Estilizar). Lo vemos en la primera sesión, que es gratis.",
      renacerNote: "Renacer es un proyecto integral a medida. En la primera sesión definimos alcance y presupuesto.",
      bookCta: "Reservar mi primera sesión gratis",
      restart: "Volver a empezar",
      prefillNote: "Tus respuestas se enviarán con la reserva para que Carlota llegue preparada."
    },
    booking: {
  ...
  en: {
    ...
    pricing: {
      ...
      sub: "The first session is free. If you decide to go ahead, projects start at €350 and scale with scope. Choose Refurnish or Design and the Style phase is included.",
      roomsLabel: "How many rooms?",
      rooms: ["1–2 rooms", "3–5 rooms", "5+ rooms"],
      weeks: "weeks", popular: "Most chosen", custom: "Bespoke quote", customWeeks: "Timeline per project",
      ...
      rule3: "Minimum cost if you go ahead: €350. Indicative prices depending on scope; VAT not included.",
      tableToggle: "See full price and timeline table",
      tableScope: "Scope",
      features: {
    ...
    quiz: {
      ...
      sub: "Answer 5 questions and I'll tell you which service fits, with an indicative price and timeline. Then book your free first session.",
      ...
      estimate: "Indicative investment", duration: "Estimated timeline", weeksShort: "wks",
      customPrice: "Bespoke", customWeeks: "Per project",
      inclNote: "As a {service} project, the Style phase is included at no cost.",
      budgetNote: "With your budget we can start with a narrower version (fewer rooms or Style). We'll look at it in the first session, which is free.",
      renacerNote: "Renacer is a bespoke full-scope project. We define scope and budget in the first session.",
      bookCta: "Book my free first session",
      restart: "Start over",
  ...
  it: {
    ...
    pricing: {
      ...
      sub: "La prima sessione è gratuita. Se decidi di procedere, il progetto parte da 350 € e cresce con l'ambito. Se scegli Riarredare o Progettare, la fase Stilizzare è inclusa.",
      roomsLabel: "Quante stanze?",
      rooms: ["1–2 stanze", "3–5 stanze", "+5 stanze"],
      weeks: "settimane", popular: "Il più scelto", custom: "Preventivo su misura", customWeeks: "Tempi in base al progetto",
      ...
      rule3: "Costo minimo se decidi di procedere: 350 €. Prezzi indicativi in base all'ambito; IVA esclusa.",
      tableToggle: "Vedi la tabella completa di prezzi e tempi",
      tableScope: "Ambito",
      features: {
    ...
    quiz: {
      ...
      sub: "Rispondi a 5 domande e ti dico quale servizio è adatto, con prezzo e tempi indicativi. Poi prenota la tua prima sessione gratuita.",
      ...
      estimate: "Investimento indicativo", duration: "Tempi stimati", weeksShort: "sett.",
      customPrice: "Su misura", customWeeks: "In base al progetto",
      inclNote: "Trattandosi di un progetto {service}, la fase Stilizzare è inclusa senza costi.",
      budgetNote: "Con il tuo budget possiamo partire da una versione più contenuta (meno stanze o Stilizzare). Lo vediamo nella prima sessione, che è gratuita.",
      renacerNote: "Renacer è un progetto integrale su misura. Nella prima sessione definiamo ambito e budget.",
      bookCta: "Prenota la mia prima sessione gratuita",
      restart: "Ricomincia",
